...
\include{functions/Worksheet-1.1-new}

\include{functions/Preclass-1.3}
\include{functions/Worksheet-1.3}

\include{functions/Preclass-1.4}
\include{functions/Worksheet-1.4}

\include{functions/Preclass-1.5}
\include{functions/Worksheet-1.5}

\include{functions/Preclass-1.6A}
\include{functions/Worksheet-1.6a}

\include{functions/Preclass-1.6B}
\include{functions/Worksheet-1.6b}

\include{functions/Preclass-1.7}
\include{functions/Worksheet-1.7}

\include{functions/Preclass-1.8}
\include{functions/Worksheet-1.8}

\include{functions/Preclass-2.1A}
\include{functions/Worksheet-2.1a}

\include{functions/Preclass-2.1B}
\include{functions/Worksheet-2.1b}

\include{functions/Worksheet-Problem-Solving}
