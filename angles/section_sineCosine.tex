...
\begin{minipage}{0.5\linewidth}
  \begin{tikzpicture}[scale=3]
    ...
    \filldraw [black] (30:1cm) circle [radius=0.015cm];
    ...
    \draw[green,thick] (.2cm,0cm) arc [start angle=0, end angle=30,radius=.2cm]; 
    \draw[red!80,thick] (30:1cm) -- ++(0,-0.5cm); 
    \draw[blue!80,thick] (0,0) -- (30:1cm); 
...
\begin{minipage}{0.5\linewidth}
  \begin{tikzpicture}[scale=3]
    ...
    \draw (0,-1.1) -- (0,1.1); 
    \draw (0,0) circle [radius=1cm];
    \filldraw [black] (150:1cm) circle [radius=0.015cm];
    ...
    \draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=150,radius=.1cm]; 
    \draw[red!80,thick] (150:1cm) -- ++(0,-0.5cm); 
    \draw[blue!80,thick] (0,0) -- (150:1cm); 
...
\begin{minipage}{0.5\linewidth}
  \begin{tikzpicture}[scale=3]
    ...
    \draw (0,-1.1) -- (0,1.1); 
    \draw (0,0) circle [radius=1cm];
    \filldraw [black] (210:1cm) circle [radius=0.015cm];
    ...
    \draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=210,radius=.1cm]; 
    \draw[red!80,thick] (210:1cm) -- ++(0,0.5cm); 
    \draw[blue!80,thick] (0,0) -- (210:1cm); 
...
\begin{minipage}{0.5\linewidth}
  \begin{tikzpicture}[scale=3]
    ...
    \draw (0,-1.1) -- (0,1.1); 
    \draw (0,0) circle [radius=1cm];
    \filldraw [black] (330:1cm) circle [radius=0.015cm];
    ...
    \draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=330,radius=.1cm]; 
    \draw[red!80,thick] (330:1cm) -- ++(0,0.5cm); 
    \draw[blue!80,thick] (0,0) -- (330:1cm); 
...
\draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=60,radius=.1cm];
\draw[red!80,thick] (0.5,0) -- (60:1cm);
\draw[blue!80,thick] (0,0) -- (60:1cm);
...
\draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=120,radius=.1cm];
\draw[red!80,thick] (-0.5,0) -- (120:1cm);
\draw[blue!80,thick] (0,0) -- (120:1cm);
...
\foreach \x in {-1,-0.5,0.5,1} {
   ...
   \draw (\x cm,6pt) node[anchor=north,fill=white] {$\x$};
}
\foreach \y in {-1,-0.5,0.5,1}{
...
\draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=240,radius=.1cm];
\draw[red!80,thick] (-0.5,0) -- (240:1cm);
\draw[blue!80,thin] (0,0) -- (240:1cm);
\draw (135:0.25cm) node {$4\pi/3$};
\draw (0,1.2cm) node {$y$};
\draw (1.2cm,0) node {$x$};
...
\begin{tikzpicture}[scale=3]
  ...
  \draw[green,thick] (.1cm,0cm) arc [start angle=0, end angle=300,radius=.1cm];
  \draw[red!80,thick] (0.5,0) -- (300:1cm);
  \draw[blue!80,thick] (0,0) -- (300:1cm);
  \draw (135:0.25cm) node {$5\pi/3$};
  \draw (0,1.2cm) node {$y$};
  \draw (1.2cm,0) node {$x$};
