...
\item For this problem, let $g(x)=\sqrt{x}$.
\begin{enumerate}
\item Graph $g(x)=\sqrt{x}$.  Then determine the domain and range of $g(x)$.\\
\begin{tikzpicture}[y=.5cm, x=0.5cm,font=\sffamily]
    %% ticks
...
\vfill
\item Graph and label $g(x)-3$ on the coordinate system above.  Then determine the domain and range of $g(x)-3$.\vfill
\vfill
\end{enumerate}
...
\item For this problem, let $h(x)=x$.
\begin{enumerate}
\item Graph $h(x)=x$.  Then determine the domain and range of $h(x)$.\\
\begin{tikzpicture}[y=.5cm, x=0.5cm,font=\sffamily]
    %% ticks
    \draw[step = 1, gray] (-11,-11) grid (11,11);
    %% axis
...
\vfill
\item Graph and label $h(x)+1$ on the coordinate system above.  Then determine the domain and range of $h(x)+1$.\vfill
\vfill
\end{enumerate}

\clearpage

\item For this problem, let $k(x)=x^2$.
\begin{enumerate}
\item Graph $k(x)=x^2$.  Then determine the domain and range of $k(x)$.\\
\begin{tikzpicture}[y=.5cm, x=0.5cm,font=\sffamily]
    %% ticks
    \draw[step = 1, gray] (-11,-11) grid (11,11);
    %% axis
...
\vfill
\item Graph and label $k(x-2)$ on the coordinate system above.  Then determine the domain and range of $k(x-2)$.\vfill
\vfill
\end{enumerate}
