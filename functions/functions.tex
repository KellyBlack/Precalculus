...
%\include{functions/section_circles}

\include{functions/section_functions}

\include{functions/section_linear}

\include{functions/section_linear_models}

\include{functions/section_functionGraphs}

\include{functions/section_piecewise}

\include{functions/section_operations}

\include{functions/section_quadratics}

\include{functions/section_polynomial}

\include{functions/section_factorPolynomial}
