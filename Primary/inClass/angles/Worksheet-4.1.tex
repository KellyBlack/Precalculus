...
\item The author of a video game will construct a path that
  ...
  \begin{tikzpicture}[y=1.0cm, x=1.0cm,font=\sffamily]
    \draw[very thick,black] (0,0) -- (30:2)  arc (30:330:2) -- cycle;
    \draw[thin,black] (-30:0.5) arc (-30:30:0.5);
    \node[anchor=west,black] at (0:0.5) {$\frac{\pi}{3}$};
    \node[anchor=east,black,xshift=-5] at (30:1.25) {$r$};
  \end{tikzpicture}
