...
\item A species of bacteria is able to divide every three hours, and
  ...
  \item At $t=3$ hours. (Do not simplify the expression.)
    \sideNote{Your answer should be expressed as the product of two
      numbers.}
...
\item A bank offers a savings account in which the interest is
  ...
  \sideNote{Try to mimic the steps in the previous question.}
...
\item Simplify each expression below.
  ...
  \item $\frac{3^5\cdot 3^2}{3^4}$
    \sideNote{Break each operation you make into separate steps and
...
\begin{tikzpicture}[
  ...
  \draw [-,red!30] (-11.0,0) -- (11.5,0) 
        node [red,anchor=west] {\scriptsize Period 0};
  \draw [-,red!30] (-11.0,-1.6) -- (11.5,-1.6) 
        node [red,anchor=west] {\scriptsize Period 1};
  \draw [-,red!30] (-11.0,-3.3) -- (11.5,-3.3) 
        node [red,anchor=west] {\scriptsize Period 2};
  \draw [-,red!30] (-11.0,-4.9) -- (11.5,-4.9) 
        node [red,anchor=west] {\scriptsize Period 3};
  \draw [-,red!30] (-11.0,-6.6) -- (11.5,-6.6) 
        node [red,anchor=west] {\scriptsize Period 4};

  \draw [->,blue!40] (12.5,-0.5) -- (12.5,-1.2) 
        node[blue,anchor=south west,yshift=-1] {\scriptsize 6 hours};
