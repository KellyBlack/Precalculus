...
\noindent MATH 1113   \hfill 3.2 - Exponential Functions\\
...
\section{Exponential Function Base $e$}


\noindent Just like the number $\pi \approx 3.14159$ is important to the study of circles and angle measures, the number $e \approx 2.71828$ is important to problems involving exponential exponential functions (and their inverses).\\
...
\section{Exponential Functions in Applications}
\noindent Increasing and decreasing exponential functions can be used in a variety of real world applications.  For example:
\begin{itemize}
