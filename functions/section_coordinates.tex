...
\begin{problem}
\item Make a sketch of the graph of the relationship $y=x^2-1$ on the
  axes below. Determine the $x$ and $y$-intercepts of the
  relationship and then mark the points on your graph.
