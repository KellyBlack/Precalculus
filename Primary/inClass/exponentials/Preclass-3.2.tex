...
\item  Graph $\displaystyle f(x)=\left(\frac{1}{4}\right)^x$ along
  with it's asymptote.  (It is helpful to plot values for $x=0, 1,
  -1$.)
  \label{question:preclass:3.2:q1}
...
\item Transform $f(x)$ from part \ref{question:preclass:3.2:q1} to
  graph $\displaystyle g(x)=\left(\frac{1}{4}\right)^{x+3}-2$ along
  with it's asymptote.
