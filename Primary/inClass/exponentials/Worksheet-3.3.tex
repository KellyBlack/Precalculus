...
\item Determine the inverse of each of the following functions.
  ...
  function and its inverse.  \sideNote{If you are unsure of the domain
    and range make a quick sketch of the graph of the function.}
\begin{enumerate}
\item $f(x)=\log_3(x)$
...
\item The advent of high frequency stock trading has motivated
  ...
  day would be \sideNote{Note that the price of a security is a real
