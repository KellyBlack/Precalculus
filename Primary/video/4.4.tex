...
\begin{enumerate}
\item Let $P(-6,8)$ be a point on the terminal side of $\theta$.
      Find each of the six trig functions of $\theta$.\\[2in]
...
\begin{tikzpicture}[y=2cm, x=2cm,font=\sffamily]
     \begin{scope}[shift={(0,0)},scale=1]
       \fill [blue!10!white] (0,0) rectangle (1.5,1.5);
       \fill [red!10!white] (-1.7,0) rectangle (0.,1.5);
       \fill [green!10!white] (-1.7,-1.5) rectangle (0,0);
       \fill [orange!10!white] (0,-1.5) rectangle (1.5,0);
       \draw[thick,->] (-1.7,0) -- (1.5,0) node[anchor=south west,font=\scriptsize] {$x$};
       \draw[thick,->] (0,-1.5) -- (0,1.5) node[anchor=east,font=\scriptsize] {$y$};
       \node at (0.8,1.2) [anchor=north,align=center,text width=8em,yshift=0em] {\textbf{Quadrant I} \\ All functions positive};
       \node at (-0.8,1.2) [anchor=north,align=center,text width=8em,yshift=0em] {\textbf{Quadrant II} \\ Sine and cosecant positive, all others negative.};
       \node at (-0.8,-0.2) [anchor=north,align=center,text width=8em,yshift=0em] {\textbf{Quadrant III} \\ Tangent and cotangent positive. All others negative.};
       \node at (0.8,-0.2) [anchor=north,align=center,text width=8em,yshift=0em] {\textbf{Quadrant IV} \\ Coine and secant positive, all others negative.};
     \end{scope}
\end{tikzpicture}
...
\end{tabular}
     ...
     \begin{tikzpicture}[y=2.0cm, x=2.0cm,font=\sffamily]
       \begin{scope}[shift={(-2.75,0)},scale=1.0]
         \draw[black,->] (-1.1,0) -- (1.1,0) node[anchor=south west] {$x$};
         \draw[black,->] (0,-1.1) -- (0,1.1) node[anchor=south east] {$y$};
         \draw[ultra thick,blue!50!black,<->] (1,0) -- (0,0) -- (135:1);
         \draw[thin,black,->] (0.3,0) arc (0:133:0.3) node[anchor=south west,pos=0.5] {$\theta$};
         \draw[thin,black,->] (135:0.5) arc (135:180:0.5) node[anchor=south east,pos=0.5] {$\theta_R$};
         \draw[thin,black] (135:0.4) arc (135:180:0.4);
         \node[anchor=north,font=\scriptsize,text width=9em,align=left] at (0,-1.1)
             {If $90^\circ<\theta<180^\circ$, then $\theta_R=180^\circ-\theta$};
       \end{scope}
       \begin{scope}[shift={(0,0)},scale=1.0]
         \draw[black,->] (-1.1,0) -- (1.1,0) node[anchor=south west] {$x$};
         \draw[black,->] (0,-1.1) -- (0,1.1) node[anchor=south east] {$y$};
         \draw[ultra thick,blue!50!black,<->] (1,0) -- (0,0) -- (225:1);
         \draw[thin,black,->] (0.3,0) arc (0:223:0.3)  node[anchor=south east,pos=0.5] {$\theta$};
         \draw[thin,black,->] (180:0.5) arc (180:225:0.5) node[anchor=north east,pos=0.5] {$\theta_R$};
         \draw[thin,black] (180:0.4) arc (180:225:0.4);
         \node[anchor=north,font=\scriptsize,text width=9em,align=left] at (0,-1.1)
             {If $180^\circ<\theta<270^\circ$, then $\theta_R=\theta-180^\circ$};
       \end{scope}
       \begin{scope}[shift={(2.75,0)},scale=1.0]
         \draw[black,->] (-1.1,0) -- (1.1,0) node[anchor=south west] {$x$};
         \draw[black,->] (0,-1.1) -- (0,1.1) node[anchor=south east] {$y$};
         \draw[ultra thick,blue!50!black,<->] (1,0) -- (0,0) -- (315:1);
         \draw[thin,black,->] (0.3,0) arc (0:312:0.3)  node[anchor=south east,pos=0.5] {$\theta$};
         \draw[thin,black,->] (315:0.5) arc (315:360:0.5) node[anchor=north west,pos=0.5] {$\theta_R$};
         \draw[thin,black] (315:0.4) arc (315:360:0.4);
         \node[anchor=north,font=\scriptsize,text width=9em,align=left] at (0,-1.1)
             {If $270^\circ<\theta<360^\circ$, then $\theta_R=360^\circ-\theta$};
       \end{scope}
     \end{tikzpicture}
