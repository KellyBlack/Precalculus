...
\item In one cycle a type of mayfly lays eggs and on average three
  ...
  \item Draw a tree diagram of the individuals from each cycle that
    ...
    your diagram. The node for the first mayfly should be at the top
    center of the space, and then the generations that follow should be
    below the previous generations in the diagram.
    \vfill
