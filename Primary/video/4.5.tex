...
\noindent MATH 1113   \hfill 4.5 - Graphs of Sine and Cosine Functions\\
...
\hrule 
\vspace{5mm}
\section{Graph $y=\sin(x)$ and $y=\cos(x)$}
...
\section{Determine a Formula for a Sine or Cosine Wave}
\item Express the equation for the sine wave shown below in the form $y=a\sin(bx+c)+d$. Then express the equation for the cosine wave shown below in the form $y=a\cos(bx+c)+d$.  In your equation, use $a>0$, $b>0$, and the least possible positive real number $c$.
...
%
%
%\section{Model Sinusoidal Behavior}
%
%
