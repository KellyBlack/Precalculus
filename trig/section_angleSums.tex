...
\item Use the identity
  ...
  \end{eqnarray*}
  as well as what you know about the value of
  $\cos\left(\frac{\pi}{6}\right)$ to determine the values of
  $\cos\left(\frac{\pi}{12}\right)$ and
  $\sin\left(\frac{\pi}{12}\right)$.
  \sideNote{Use another identity to help reduce the expression in terms of one of the missing values.}
